...
public class ExamSliderAdapter extends FragmentPagerAdapter {
    public static String TAG = "*****" + ExamSliderAdapter.class.getName();
    private int count;
    private List<Word> words;
    public ExamSliderAdapter(FragmentManager fm, int count, List<Word> words) {
        super(fm);
        this.count = count;
        this.words = words;
    }
